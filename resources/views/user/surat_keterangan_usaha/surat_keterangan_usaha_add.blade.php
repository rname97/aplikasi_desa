            ...
            <div class="card-body py-4 px-5">
                <div class="px-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                        <input type="text" name="pekerjaan_input" class="form-control" id="basic-default-company" required />
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-md-3 col-form-label" for="basic-default-company">Type Usaha</label>
                        <div class="col-md-9">
                        <input type="text" name="typeUsaha_input" class="form-control" id="basic-default-company" required/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-md-3 col-form-label" for="basic-default-company">Lokasi Usaha</label>
                        <div class="col-md-9">
                        <input type="text" name="lokasiUsaha_input" class="form-control" id="basic-default-company" required/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-md-3 col-form-label" for="basic-default-company">Mulai Usaha</label>
                        <div class="col-md-9">
                        <input type="text" name="mulaiUsaha_input" class="form-control" id="basic-default-company" required/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-md-3 col-form-label" for="basic-default-company">Foto Bukti Usaha</label>
                        <div class="col-md-9">
                            <input type="file" name="fotoUsaha_input" class="form-control" id="basic-default-company"  required/>
                        </div>
                    </div>
                </div>
            </div>
