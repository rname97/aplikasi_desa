                            ...
                            @if ($rowSPKK->status_id == 2)
                                <div class="px-3">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            @if ($rowSPKKProses->spkkFile != '')
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-center">
                                                            <i class="fa-regular fa-file-pdf fa-solid fa-5x"></i>
                                                        </div>
                                                        <p>{{ $rowSPKKProses->spkkFile }}</p>
                                                        <hr>
                                                        <a class="btn btn-primary btn-sm" href="{{URL::asset('spkkFileSuccess/'.$rowSPKKProses->spkkFile)}}" target="_blank">Download</a>
                                                    </div>
                                                </div>
                                            @else
