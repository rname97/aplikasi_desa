<meta charset="utf-8" />
    ...
    <title>Dashboard - Analytics | Materio - Bootstrap Material Design user Template</title>
    ...
    <link rel="stylesheet" href="{{ asset('/user') }}/assets/vendor/fonts/materialdesignicons.css" />

    <!-- Menu waves for no-customizer fix -->
    <link rel="stylesheet" href="{{ asset('/user') }}/assets/vendor/libs/node-waves/node-waves.css" />
