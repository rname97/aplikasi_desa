...
<div class="container mt-5 mb-5 h-100 " >
    ...
    <!-- Basic Layout -->
    <form method="POST" action="{{ url('/user/submitEditSPKTP') }}/{{ $rowSPKTP->id }}" enctype="multipart/form-data">
                    ...
                    <div class="card-header py-4" style="background-color:#0c386e; color: #ffffff;">
                        <div class="mx-3">
                            ...
                            <div class="float-start">
                                <h5>TAMBAH PENDAFTARAN SURAT PENGANTAR KTP</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body py-4 px-5">
                        <div class="px-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                <input type="text" name="noKartuKeluarga_input" class="form-control" id="basic-default-company" required value="{{$rowSPKTP->noKartuKeluarga}}"/>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-md-3 col-form-label" for="basic-default-company">Foto Kartu Keluarga</label>
                                <div class="col-md-9">
                                    <input type="file" name="fotoKartuKeluarga_input" class="form-control" id="basic-default-company" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-3 col-form-label" for="basic-default-name">Current Image</label>
                                <div class="col-sm-9">
