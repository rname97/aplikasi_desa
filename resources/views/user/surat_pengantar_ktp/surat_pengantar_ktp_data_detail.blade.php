            ...
            <div class="col-sm-8">
                <div class="card shadow-lg bg-body rounded">
                    <div class="card-header py-4" style="background-color:#0c386e; color: #ffffff;">
                        <div class="mx-3">
                            ...
                            <div class="float-start">
                                <h5>DETAIL PENDAFTARAN SURAT PENGANTAR KTP</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body ">
                        <div class="py-4 px-5">
                            <div class="px-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                    <input type="text" name="nama_input" class="form-control" id="basic-default-company" disabled value="{{$rowUser->agama}}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-md-3 col-form-label" for="basic-default-company">No Telp</label>
                                    <div class="col-md-9">
                                    <input type="text" name="nama_input" class="form-control" id="basic-default-company" disabled value="{{$rowUser->noTelp}}" />
                                    </div>
                                </div>
                                ...
                                <hr>
                                <div class="row mb-3">
                                    <label class="col-md-3 col-form-label" for="basic-default-company">No Kartu Keluarga</label>
                                    <div class="col-md-9">
                                    <input type="text" name="pekerjaan_input" class="form-control" id="basic-default-company" value="{{$rowSPKTP->noKartuKeluarga}}"/>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-md-3 col-form-label" for="basic-default-name">Foto Kartu Keluarga</label>
                                    <div class="col-md-9">
                                        @if ($rowSPKTP->fotoKartuKeluarga != '')
                                            <input type="hidden" name="fotoUsaha_inputCurent" class="form-control" id="basic-default-name" value="{{ $rowSPKTP->fotoKartuKeluarga }}">
                                            <img src="{{url('images/spktp/'.$rowSPKTP->fotoKartuKeluarga)}}" alt="" width="100" height="100">
                                        @else
                            ...
                            @if ($rowSPKTP->status_id == 2)
                                <div class="px-3">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            @if ($rowSPKTPProses->spktpFile != '')
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-center">
                                                            <i class="fa-regular fa-file-pdf fa-solid fa-5x"></i>
                                                        </div>
                                                        <p>{{ $rowSPKTPProses->spktpFile }}</p>
                                                        <hr>
                                                        <a class="btn btn-primary btn-sm" href="{{URL::asset('spktpFileSuccess/'.$rowSPKTPProses->spktpFile)}}" target="_blank">Download</a>
                                                    </div>
                                                </div>
                                            @else
                                                <img src="{{URL::asset('images/user/image_empty.jpg')}}" alt="" width="100" height="100">
                            ...
                            @elseif ($rowSPKTP->status_id == 3)
                                <div class="px-3">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="" class="form-control" disabled>{{ $rowSPKTPProses->spktpDeskFailed}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            @endif
                    ...
                    <div class="card-footer p-4">
                        <div class="float-start">
                            <a href="{{ url('/user/spktp_data') }}" class="btn btn-secondary btn-sm"><i class="fa-solid fa-left-long"></i> Back</a>
                        </div>
