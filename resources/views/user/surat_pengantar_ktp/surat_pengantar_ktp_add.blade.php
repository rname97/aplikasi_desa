...
<div class="container mt-5 mb-5 h-100 content" >
    ...
    <!-- Basic Layout -->
    <form method="POST" action="{{ route('user.submitAddSPKTP') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card-body py-4 px-5">
                <div class="px-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <input type="file" name="fotoKartuKeluarga_input" class="form-control" id="basic-default-company"  required/>
                        </div>
                    </div>
                </div>
            </div>
